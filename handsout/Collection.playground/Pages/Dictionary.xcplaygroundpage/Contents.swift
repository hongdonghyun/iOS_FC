...
let practiceDict1: [String: Int] = [:]
let practiceDict2: Dictionary<String, Int> = [:]
...
// 1번 문제
let scores32 = ["kor": 92,"eng": 88, "math": 96, "science": 89]
// 결과 : 91.25

var result =  Double(scores32.values.reduce(0, +)) / Double(scores32.count)

// 2번 문제
 let scores2 = ["kor": 92,"eng": 88, "math": 96, "science": 89]
// 결과 : [("kor", 92), ("eng", 88), ("math", 96), ("science", 89)]

var scores2Array: [(String, Int)] = []
for (key, value) in scores2 {
    scores2Array.append((key,value))
}
scores2Array
